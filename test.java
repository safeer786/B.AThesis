...
//	Obstacles:  (0, 3); (0, 6); (1, 6); (4, 2); (4, 4); (6, 4);
	...
	public static void main(String[] args) {
		...
		String w1="safeer";
		String w2="saf";
		System.out.println(w1.substring(0,2));
		System.out.println(w1.substring(2,5));
		w1=w1.replaceFirst("e", "a");
		System.out.println(w1);
		w1=w1.replaceFirst("e", "a");
		System.out.println(w1);
//		System.out.println(w1.substring(0,0));
//		System.out.println(w1.substring(0,1));
//		System.out.println(w1.substring(0,2));
//		System.out.println(w1.substring(w2.length(),w1.length()));
//		for(int i=0;i<w1.length();i++)
//		{
//			System.out.println(w1.substring(i, w1.length()));
//		}
		//t.go_to(0,2);
